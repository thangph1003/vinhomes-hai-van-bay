      ...
      <section id="vi-tri-du-an" className="relative bg-[url('/images/independent-position.webp')] bg-cover bg-left-top md:h-[742px] h-[239px] z-[2]">
        <div className="max-w-[1152px] mx-auto">
          <div className="md:w-[411px] flex flex-col md:justify-self-end absolute md:bottom-[135px] md:text-end z-1 bg-white p-5 md:bg-transparent md:p-0 mx-[22px] top-[207px]">
            ...
            <h2 className="md:text-[44px] text-[32px] md:leading-[57px] leading-[42px] text-[#162B75] font-bold font-crimson-text">- ĐỊA THẾ VÔ SONG</h2>
            <p className="text-base leading-6 font-normal font-montserrat text-black pt-2.5">Vinhomes Làng Vân tọa lạc trên vùng đất hiếm hoi còn nguyên vẹn vẻ đẹp núi - rừng - biển giao hòa. Gắn liền với “Thiên hạ đệ nhất hùng quan”, vị trí này không chỉ mang giá trị thiên nhiên và di sản, mà còn mở ra khả năng kết nối thuận lợi tới các đô thị lân cận, hình thành dấu ấn biểu tượng hiếm có trong phát triển bất động sản ven biển.
            </p>
          </div>
        </div>
      </section>
      ...
      <div className="w-full bg-white">
        ...
        <div className="flex lg:flex-row flex-col gap-6">
            <div className="lg:w-1/2 w-full flex flex-col gap-[11px]">
                <h2 className="md:text-[28px] text-[26px] md:leading-[36px] leading-[34px] font-bold font-crimson-text text-[#DCA447]">ĐỘNG LỰC HẠ TẦNG – ĐÒN BẨY GIÁ TRỊ                </h2>
                <p className="text-base leading-6 font-normal font-montserrat text-black">Nằm trong vùng hưởng lợi trực tiếp từ cảng Liên Chiểu, khu thương mại tự do và khu công nghệ cao, Vinhomes Làng Vân sở hữu lợi về hạ tầng phát triển. Đây là nền tảng quan trọng thúc đẩy thương mại, dịch vụ, dòng vốn và nhu cầu lưu trú dài hạn cho toàn khu vực.
                </p>
            </div>
            <div className="lg:w-1/2 w-full flex flex-col gap-[3px]">
                <h2 className="md:text-[28px] text-[26px] md:leading-[36px] leading-[32px] font-bold font-crimson-text text-[#DCA447]">CỬA NGÕ DI SẢN – KẾT NỐI LIÊN VÙNG
                </h2>
                <p className="text-base leading-6 font-normal font-montserrat text-black">Gắn liền với đèo Hải Vân - “Thiên hạ đệ nhất hùng quan”, Vin Hải Vân nằm tại điểm giao thoa của trục di sản miền Trung, kết nối vịnh Nam Chơn, dãy Bạch Mã, Cố đô Huế và Phố cổ Hội An. Vị trí này xác lập vai trò cửa ngõ trên trục du lịch - nghỉ dưỡng liên vùng, hội tụ giá trị an cư, trải nghiệm và kết nối quốc tế.
                </p>
            </div>
        </div>
        <div className="flex lg:flex-row flex-col-reverse lg:border-b-0 border-b-[13px] border-[#DCA447]">
          <div className="lg:w-[26.9%] w-full bg-[#f3e9d8] px-[30px] py-10 flex flex-col gap-2.5">
            <h3 className="text-[28px] leading-[38px] font-bold font-crimson-text text-[#162B75]">THẾ ĐẤT PHONG THỦY – NỀN TẢNG TRƯỜNG TỒN
            </h3>
            <div className="flex flex-col gap-6">
            <p className="text-base leading-6 font-normal font-montserrat text-black">Vinhomes Hải Vân Bay được bao bọc bởi địa hình có cấu trúc khép kín: dãy núi Hải Vân làm thế che chở phía sau, vịnh Nam Chơn mở rộng phía trước. Núi giữ – biển tụ, tạo nên không gian phong thủy cân bằng, nơi sinh khí được nuôi dưỡng và lưu chuyển ổn định.
            </p>
            <p className="text-base leading-6 font-normal font-montserrat text-black">Sự hài hòa giữa địa hình, hướng mở và dòng khí tự nhiên hình thành nền tảng an cư bền vững, mang ý nghĩa về tài lộc, thịnh vượng và giá trị sống lâu dài theo quan niệm Á Đông.
            </p>
            </div>
          </div>
