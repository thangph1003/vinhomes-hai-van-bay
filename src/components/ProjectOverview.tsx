...
export default function ProjectOverview() {
  return (
    <section id="tong-quan" className="bg-[#F6E9D5]">
      <div className="max-w-[1152px] mx-auto relative md:pt-[73px] md:pb-[52px] pt-[59px] pb-[35px]">
        <span className="absolute inset-x-0 top-8 z-0 text-center md:text-[200px] text-[150px] leading-[200px] text-[#F0E0C680] font-normal font-crimson-text select-none pointer-events-none">
          LÀNG VÂN
        </span>
        ...
        <div className="relative z-10 flex flex-col items-center gap-[5px]">
          ...
          <h2 className="md:text-[44px] text-[32px] md:leading-[57px] leading-[42px] font-bold font-crimson-text text-[#162B75]">TỔNG QUAN DỰ ÁN</h2>
        </div>
  ...
  <div className="md:px-[30px] md:pt-[30px] md:pb-[150px] pt-[30px] pb-[100px] px-5">
    <dl className="flex flex-col md:gap-[14px] gap-2.5">

      <div className="flex md:flex-row flex-col items-start md:gap-6 gap-[5px] md:pb-[14px] pb-2.5 border-b border-[#F0E0C6]">
        <dt className="md:w-[21.8%] w-full text-base leading-6 font-bold font-montserrat text-[#162B75]">
          Tên dự án
        </dt>
        <dd className="flex-1 text-base leading-6 text-black font-normal font-montserrat">
          Vinhomes Hải Vân Bay – Đà Nẵng (Vinhomes Heaven Bay)
        </dd>
      </div>

      <div className="flex md:flex-row flex-col items-start md:gap-6 gap-[5px] md:pb-[14px] pb-2.5 border-b border-[#F0E0C6]">
        <dt className="md:w-[21.4%] w-full text-base leading-6 font-bold font-montserrat text-[#162B75]">
          Vị trí dự án
        </dt>
        <dd className="flex-1 text-base leading-6 text-black font-normal font-montserrat">
          Làng Vân, Phường Hòa Hiệp Bắc, Thành phố Đà Nẵng
        </dd>
      </div>
      ...
      <div className="flex md:flex-row flex-col items-start md:gap-6 gap-[5px] md:pb-[14px] pb-2.5 border-b border-[#F0E0C6]">
        ...
        <dd className="flex-1 text-base leading-6 text-black font-normal font-montserrat">
          Căn hộ, khách sạn, shophouse, biệt thự đơn lập &amp; song lập
        </dd>
      </div>
      ...
      <div className="flex md:flex-row flex-col items-start md:gap-6 gap-[5px] md:pb-[14px] pb-2.5 border-b border-[#F0E0C6]">
        ...
        <dd className="flex-1 text-base leading-6 text-black font-normal font-montserrat">
          ~6.169 sản phẩm (cao tầng - 241 căn và thấp tầng - 5.928 căn)
        </dd>
      </div>
      ...
      <div className="flex md:flex-row flex-col items-start md:gap-6 gap-[5px] md:pb-[14px] pb-2.5 border-b border-[#F0E0C6]">
        ...
        <dd className="flex-1 text-base leading-6 text-black font-normal font-montserrat">
          Sở hữu lâu dài với khách Việt Nam (92% là Sổ Đỏ Vĩnh Viễn), 50 năm với khách hàng người nước ngoài.
        </dd>
      </div>
