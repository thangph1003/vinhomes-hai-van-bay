      ...
      <div className=" z-10 md:pt-[73px] pt-[42px] flex flex-col justify-center items-center">
        <div className="flex flex-col gap-[5px] pr-[58px] pl-[49px] sm:px-0 max-w-[653px] items-center">
         <Image src="/images/logo-cropped.png" alt='logo' width="62" height="57" className='md:w-[62px] md:h-[57px] w-[33px] h-[30px]'></Image>
          ...
          <h3 className="font-crimson-text w-full text-[#162B75] md:text-[44px] text-[32px] font-bold md:leading-[57px] leading-[42px] tracking-normal text-center">
            DỰ ÁN VINHOMES HẢI VÂN BAY
          </h3>
        </div>

        <p className="text-[#000000] max-w-[808px] leading-[24px] text-[16px] text-center font-normal font-montserrat md:mt-[25px] md:px-0 mt-[14px] pr-[31px] pl-[34px]">
        ...
        <div  className='max-w-[1151px] md:mt-[30px] mt-[26px] px-[32px] md:px-0 md:mb-[74px] mb-[37px] flex md:flex-row flex-col '>
