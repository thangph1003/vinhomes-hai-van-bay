  ...
  return (
    <section className="relative w-full bg-[#F6E9D5] overflow-hidden flex flex-col items-center">
      ...
      <div className="absolute max-w-[1007px] top-0 text-center z-0 select-none pointer-events-none">
        <span className="text-[200px] font-crimson-text font-normal text-[#F0E0C680] tracking-normal leading-[260px]">
          VINHOMES
        </span>
      </div>
      ...
      <div className=" z-10 pt-[73px] flex flex-col justify-center items-center">
        <div className="flex flex-col gap-[5px] max-w-[653px] items-center">
         <Image src="/images/logo-cropped.png" alt='logo' width="62" height="57" className='w-[62px] h-[57px]'></Image>
          ...
          <div className="font-crimson-text w-full text-[#162B75] text-[44px] font-bold leading-[57px] tracking-normal">
            DỰ ÁN VINHOMES HẢI VÂN BAY
          </div>
        </div>

        <div className="text-[#000000] max-w-[808px] leading-[24px] text-[16px] text-center font-normal font-montserrat mt-[25px]">
        ...
        <div  className='max-w-[1151px] mt-[30px] mb-[74px] flex '>
          <div className='flex flex-col w-[26.9%] px-[30px] py-[40px] bg-[#FFFFFF] gap-[10px]'>
            <div className='font-crimson-text font-bold text-[28px] leading-[36px] text-[#DCA447] tracking-normal'>LƯNG TỰA NÚI MẶT HƯỚNG BIỂN</div>
            <div className='font-montserrat font-normal text-[16px] leading-[24px] tracking-normal'> Dự án hội tụ trọn vẹn hệ giá trị sống toàn diện: tiện ích đỉnh cao, dịch vụ chuyên biệt, cộng đồng chọn lọc, và trên hết là một phong cách sống 
                  ...
                  - điểm đến của cư dân tinh hoa, nhà đầu tư và du khách thế giới.</div>
          </div>
